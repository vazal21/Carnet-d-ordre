...
class CarnetOrdres:
    ...
    def afficher_carnet(self):
        print("\nCarnet d'ordres :")
        print("--------------------------------------------------------")
        print("|  Achat  |  Quantité  |  Prix  |  Quantité  |  Vente  |")
        print("--------------------------------------------------------")
        max_length = max(len(self.achats), len(self.ventes))
        for i in range(max_length):
            ...
            if i < len(self.ventes):
                print(f" {self.ventes[i].type_ordre.ljust(7)} | {str(self.ventes[i].quantite).ljust(10)} |")
            else:
                print()
